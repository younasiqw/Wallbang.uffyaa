...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\omega configs\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\omega configs", NULL);
	...
	{
		std::string file_path = "C:\omega configs\\BlankConfig.cfg";
	...
	std::vector<std::string> CSettings::GetConfigs()
	{
		...
		WIN32_FIND_DATA ffd;
		auto directory = "C:\\omega configs\\*";
