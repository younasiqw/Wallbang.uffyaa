...
#define XorStr( s ) ( s )
				switch (int(mopvar::Globals->curtime * 2.7) % 28)
				{
				case 0:setclantag(XorStr("                  g")); break;
				case 1:setclantag(XorStr("                ge")); break;
				case 2:setclantag(XorStr("               get")); break;
				case 3:setclantag(XorStr("              geto")); break;
				case 4:setclantag(XorStr("             getom")); break;
				case 5:setclantag(XorStr("            getome")); break;
				case 6:setclantag(XorStr("           getomeg")); break;
				case 7:setclantag(XorStr("          getomega")); break;
				case 8:setclantag(XorStr("         getomega.")); break;
				case 9:setclantag(XorStr("         getomega.c ")); break;
				case 10:setclantag(XorStr("      getomega.cl  ")); break;
				case 11:setclantag(XorStr("     getomega.clu   ")); break;
				case 12:setclantag(XorStr("    getomega.club    ")); break;
				case 13:setclantag(XorStr("  getomega.club     ")); break;
				case 14:setclantag(XorStr(" getomega.club     ")); break;
				case 15:setclantag(XorStr("getomega.club      ")); break;
				case 16:setclantag(XorStr("etomega.club       ")); break;
				case 17:setclantag(XorStr("tomega.club        ")); break;
				case 18:setclantag(XorStr("omega.club         ")); break;
				case 19:setclantag(XorStr("mega.club         ")); break;
				case 20:setclantag(XorStr("ega.club           ")); break;
				case 22:setclantag(XorStr("ga.club            ")); break;
				case 23:setclantag(XorStr("a.club             ")); break;
				case 24:setclantag(XorStr(".club              ")); break;
				case 25:setclantag(XorStr("club              ")); break;
				case 26:setclantag(XorStr("ub              ")); break;
				case 27:setclantag(XorStr("b              ")); break;
	...
	void InitHooks()
	{
		...
		mopvar::cvar->ConsoleColorPrintf(CColor(0, 0, 0, 255), ("["));
		mopvar::cvar->ConsoleColorPrintf(CColor(255, 0, 255, 255), ("Wallbang.ml"));
		mopvar::cvar->ConsoleColorPrintf(CColor(0, 0, 0, 255), ("] "));
